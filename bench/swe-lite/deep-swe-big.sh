...
INSTANCES="$SCRIPT_DIR/deep_swe_big.json"
RESULTS_DIR="$SCRIPT_DIR/results-deepswe-big"
TRACES_DIR="$RESULTS_DIR/traces"
WORK_DIR="/tmp/deep-swe-bench-big"
...
printf "\n${W}══════════════════════════════════════════════════════════════${N}\n"
printf "${W}  DeepSWE Big Repos — codedb vs graphify vs codegraph vs lean-ctx vs baseline${N}\n"
printf "${W}══════════════════════════════════════════════════════════════${N}\n"
